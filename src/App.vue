...
export default {
  ...
  methods: {
    ...
    pieceDrag(e: DragEvent, i: number) {
      ...
      this.moveGen.generate(i as Square);
  ...
  mounted() {
    const testFens = [
      ...
      '1n2k1n1/1pppppp1/8/8/8/8/1PPPPPP1/1N2K1N1 w - - 0 1', // non-sliding pieces
...
<template>
  ...
  <div id="board" :class="numbered ? 'smaller' : ''">
    <div 
      role="button" :draggable="!!piece" @dragover.prevent @drop.prevent="(e) => pieceDrop(e, i)" @dragstart="(e) => pieceDrag(e, i)" @mouseover="() => lastSel = i" @contextmenu.prevent="() => highlights.toggleHighlight(i as Square)"
